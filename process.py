...
def augmentSentences(groupListVi=None, groupListBana=None, txtVi="data_vi_spr.txt", txtBana="data_bana_spr.txt",
                     outputViName="data_vi_augmentation.txt", outputBanaName="data_bana_augmentation.txt"):
    ...
    txtViAugments = open(inputsDir + '/data_vi_augmentation.txt', encoding='utf-8', errors='ignore').read()
    txtBanaAugments = open(inputsDir + '/data_bana_augmentation.txt', encoding='utf-8', errors='ignore').read()
    ...
    for i in range(num_rows):
        ...
        for j in range(groupSize):
            ...
            if (resTextVi is True and resTextBana) or (resLowerTextVi is True and resLowerTextBana is True):
                sameGroupPos = j
                shouldUseLowerText = resLowerTextVi is True
                break
    ...
    with open(inputsDir + '/' + outputViName, 'w', encoding='utf-8') as f:
        f.write(txtViAugments)
    with open(inputsDir + '/' + outputBanaName, 'w', encoding='utf-8') as f:
